                ...
                <form onSubmit={form.handleSubmit(handleCreatePayslip)} className="space-y-6">
                  ...
                  <div className="bg-gray-100 p-4 rounded-lg">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xl font-bold">₹ {netSalary.toFixed(2)}</span>
                    </div>
                  </div>
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-gray-100">
                        ...
                        <th className="px-4 py-2 text-left">Other Allowances</th>
                    ...
                    <tbody>
                      {payslips.map((payslip) => (
                        <tr key={payslip.id} className="border-b hover:bg-gray-50">
                          <td className="px-4 py-2">{payslip.month} {payslip.year}</td>
                          <td className="px-4 py-2">₹{payslip.basic_salary.toFixed(2)}</td>
                          <td className="px-4 py-2">₹{payslip.hra.toFixed(2)}</td>
                          <td className="px-4 py-2">₹{payslip.da.toFixed(2)}</td>
                          <td className="px-4 py-2">₹{payslip.ta.toFixed(2)}</td>
                          <td className="px-4 py-2">₹{payslip.other_allowances.toFixed(2)}</td>
                          <td className="px-4 py-2">₹{(payslip.epf_deduction + payslip.other_deductions).toFixed(2)}</td>
                          <td className="px-4 py-2 font-medium">₹{payslip.net_salary.toFixed(2)}</td>
                  ...
                  <div>
                    ...
                    {professionalExperience.length === 0 ? (
                      <div className="text-center p-8 border rounded-lg bg-gray-50">
                        <p className="text-gray-500">No professional experience records found</p>
                      </div>
                    ) : (
                      <div className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="bg-white rounded-lg border p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-medium mb-4">Current Salary Details</h3>
                    {salaryInfo ? (
                      <div className="space-y-4">
                        <div className="flex justify-between">
                          <span className="text-gray-600">Gross Salary:</span>
                          <span className="font-medium">₹{salaryInfo.gross_salary.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">EPF Percentage:</span>
                          <span className="font-medium">{salaryInfo.epf_percentage}%</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Total Deductions:</span>
                          <span className="font-medium">₹{salaryInfo.total_deduction.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Net Pay:</span>
                          <span className="font-medium">₹{salaryInfo.net_pay.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Last Updated:</span>
                          <span className="font-medium">
                            {salaryInfo.updated_at ? format(new Date(salaryInfo.updated_at), "MMM dd, yyyy") : format(new Date(salaryInfo.created_at), "MMM dd, yyyy")}
                          </span>
                        </div>
                      </div>
                    ) : (
                      <div className="text-center p-8 border rounded-lg bg-gray-50">
                        <p className="text-gray-500">No salary information found</p>
                      </div>
                    )}
                  </div>
                  
                  <div>
                    <h3 className="text-lg font-medium mb-4">Update Salary Information</h3>
                    <div className="space-y-4">
                      <div>
                        ...
                        <Input 
                          ...
                          onChange={(e) => {
                            const salaryInfoCopy = {...(salaryInfo || {
                              id: "",
                              employee_id: employeeId || "",
                              gross_salary: 0,
                              epf_percentage: 12,
                              ...
                              updated_at: null
                            })} as SalaryInformation;
                            
                            salaryInfoCopy.gross_salary = parseFloat(e.target.value);
                            setSalaryInfo(salaryInfoCopy);
                          }}
                        />
                      </div>
                      <div>
                        ...
                        <Input 
                          id="epf_percentage" 
                          type="number"
                          defaultValue={salaryInfo?.epf_percentage || 12}
                          onChange={(e) => {
                            const salaryInfoCopy = {...(salaryInfo || {
                              id: "",
                              employee_id: employeeId || "",
                            ...
                            salaryInfoCopy.epf_percentage = parseFloat(e.target.value);
                            setSalaryInfo(salaryInfoCopy);
                          }}
                        />
                      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      onChange={(e) => handleUpdateProfile({ employee_id: e.target.value })}
                    />
                  </div>
                  <div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input 
                      id="fathers_name" 
                      defaultValue={employee.fathers_name || ""} 
                  ...
                  <div>
                    ...
                    <Input 
                      id="mothers_name" 
                      defaultValue={employee.mothers_name || ""} 
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white border rounded-lg p-6 flex items-center shadow-sm">
              ...
              <div className="bg-white border rounded-lg p-6">
                <h3 className="text-lg font-medium mb-4">Monthly Attendance Statistics</h3>
